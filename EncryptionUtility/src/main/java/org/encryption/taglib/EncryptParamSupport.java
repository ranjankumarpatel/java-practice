...
public class EncryptParamSupport extends ParamSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4587771665063650655L;
	...
	public int doEndTag() throws JspException {
	    ...
	    if (str1 == null) {
	      if ((this.bodyContent == null) || (this.bodyContent.getString() == null)) {
	        ...
	        str1 = Encrypto.encryptText(this.bodyContent.getString().trim());
	      }
	    }
	    if (this.encode)
	    {
