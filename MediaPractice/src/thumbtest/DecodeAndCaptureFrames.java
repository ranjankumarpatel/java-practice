...
public class DecodeAndCaptureFrames extends MediaListenerAdapter
{
	...
	private static final String outputFilePrefix = "d:/videotest/snapshots/mysnapshot";
  ...
  {
	  String inputFilename = "d:/videotest/The Lone Ranger Official International Trailer #1 (2013) - Johnny Depp Movie HD - 10Youtube.com.mp4";
    
    // create a new mr. decode and capture frames
    
    new DecodeAndCaptureFrames(inputFilename);
  }
  ...
  public void onVideoPicture(IVideoPictureEvent event)
  {
    try
    {
      ...
      if (event.getTimeStamp() - mLastPtsWrite >= MICRO_SECONDS_BETWEEN_FRAMES)
      {
    	...
    	File img = new File(outputFilePrefix, System.currentTimeMillis() + ".png");
